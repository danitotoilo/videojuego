const levels = [
    {
        description: "Nivel 1: Escribe una función en C++ que solicite dos numeros para hacer una suma.",
        ...
        hints: [
            "Pista 1: se utiliza int para definir tres cosas, los dos numeros y el resultado.",
    ...
    {
        description: "Nivel 2: Escribe una función en C++ que necesita el area de un triangulo",
        correctAnswer: function(code) {
            const correctCode = `
            #include"stdio.h"
            main()
    ...
    {
        description: "Nivel 3: Escribe una función en C++ que solicite dos números, multiplicarlos por 4, y luego elevarlos al cuadrado, y decir cuál número es el mayor, cuál número es el menor, o si los dos números son iguales.",
        correctAnswer: function(code) {
            const correctCode = `
            #include"stdio.h"
            main()
